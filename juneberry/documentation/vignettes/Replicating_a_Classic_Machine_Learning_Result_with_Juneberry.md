...
```json
{
    ...
    "evaluation_procedure": "juneberry.pytorch.evaluation.evals.PyTorchEvaluationProcedure",
    "evaluation_output": "juneberry.pytorch.evaluation.evals.PyTorchEvaluationOutput",
